已按请求完成单 API 最小修复，只修改了 [test/api_test/test_nn_Module_register_load_state_dict_post_hook.py](test/api_test/test_nn_Module_register_load_state_dict_post_hook.py#L55)。

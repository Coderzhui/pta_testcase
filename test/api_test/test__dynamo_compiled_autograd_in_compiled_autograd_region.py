"""
测试目的：验证 `torch._dynamo.compiled_autograd.in_compiled_autograd_region` 在 NPU eager 场景下可读取并返回稳定的布尔结果。
...
def test_flag_like_api_returns_bool_in_npu_eager_mode():
    ...
    value = torch._dynamo.compiled_autograd.in_compiled_autograd_region
